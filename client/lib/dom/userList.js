...
export const renderEmptyCard = (target) => insertLast(target, createEmptyCard());

export const renderSpinner = (target) => insertLast(target, createSpinner());

export const renderUserCard = (target, data) => insertLast(target, createUserCard(data));
